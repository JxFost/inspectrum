...
const FOLLOWUP_MARKER = 'followup_sent: true'
...
/**
 * Check whether the event description has the follow-up-sent marker.
 */
export function hasFollowupMarker(description) {
  return !!description && description.includes(FOLLOWUP_MARKER)
}

/**
 * Append the follow-up-sent marker to a description string.
 */
export function appendFollowupMarker(description) {
  return `${description}\n${FOLLOWUP_MARKER}\n`
}
