...
${emailLogoHeader(logoUrl)}
        ...
        <tr><td style="background-color:#FFFFFF;padding:40px;">
          ...
          <p style="font-size:18px;margin:0 0 8px;color:#2B7E8C;font-weight:600;">${rescheduled ? `You're all set, ${firstName} — your inspection has been rescheduled.` : `Great news, ${firstName} — your inspection is booked.`}</p>
          <p style="font-size:15px;margin:0 0 28px;color:#3D3F40;line-height:1.6;">
            ${rescheduled ? 'Your new appointment details are below. We\'ll send a reminder 48 hours beforehand.' : 'Here are your details below. We\'ll send a reminder 48 hours beforehand.'}
          </p>
...
${radonAddOn ? `
          <!-- Radon prep -->
          <div style="background-color:#FAF7F1;border-radius:6px;padding:20px;margin-bottom:28px;border:1px solid #E2DDD5;">
            <div style="font-size:11px;text-transform:uppercase;letter-spacing:0.2em;color:#2B7E8C;font-weight:600;margin-bottom:8px;">You Added Radon Testing</div>
            <p style="font-size:14px;color:#3D3F40;line-height:1.6;margin:0 0 12px;">
              An accurate 48-hour radon test depends on a few simple "closed-house conditions" — windows kept closed, certain fans off, and leaving the monitor undisturbed. Please review the guidelines so your results stay valid.
            </p>
            <a href="${siteUrl}/services/radon#prepare" style="display:inline-block;background-color:#2B7E8C;color:#FFFFFF;padding:12px 24px;border-radius:4px;font-size:14px;font-weight:600;text-decoration:none;">Review Radon Test Guidelines</a>
          </div>
` : ''}
          <!-- Your inspector -->
