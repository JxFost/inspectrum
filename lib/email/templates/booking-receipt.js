...
${emailLogoHeader(logoUrl)}
        ...
        <tr><td style="background-color:#FFFFFF;padding:40px;">
          ...
          <p style="font-size:15px;margin:0 0 28px;color:#3D3F40;line-height:1.6;">
            Here are your details below. ${agreementUrl ? '<strong>One thing left:</strong> please review and sign your inspection agreement before your appointment.' : ''} We'll send a reminder 48 hours beforehand.
          </p>
