  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#FAF7F1;padding:40px 20px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <!-- Header -->
        <tr><td style="background-color:#143C44;padding:16px 40px;border-radius:8px 8px 0 0;text-align:center;">
          <img src="${logoUrl}" alt="Inspectrum Inspections" width="220" style="display:inline-block;max-width:220px;height:auto;" />
        </td></tr>
