...
` : ''}
          ...
          <!-- Access request -->
          <div style="border-left:3px solid #2B7E8C;padding:4px 0 4px 18px;margin:0 0 28px;">
            <p style="font-size:14px;color:#1F2426;line-height:1.6;margin:0 0 10px;font-weight:600;">Help us give you a thorough inspection</p>
            <p style="font-size:14px;color:#3D3F40;line-height:1.6;margin:0;">
              Please make sure there's clear access to all attic, crawlspace, HVAC, plumbing, and electrical equipment access points. The more we can reach, the more complete your report will be.
            </p>
          </div>

          <p style="font-size:14px;color:#3D3F40;line-height:1.6;margin:0 0 8px;">
            If there's anything specific about the property you'd like the inspector to know beforehand, give us a call at <a href="tel:${officePhoneDigits}" style="color:#2B7E8C;font-weight:500;">${officePhone}</a>.
          </p>
          <p style="font-size:14px;color:#3D3F40;line-height:1.6;margin:0;">
            Don't hesitate to reach out with any questions or concerns — we're happy to help. Thank you, ${firstName}!
          </p>
