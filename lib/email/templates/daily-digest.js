  ...
  const rows = inspections.map((i) => `
    <tr>
      ...
      <td style="padding:12px 16px;border-bottom:1px solid #E2DDD5;vertical-align:top;">
        ...
        ${i.phone ? `<div style="font-size:13px;color:#3D3F40;display:flex;align-items:center;"> <a href="tel:${i.phone.replace(/[^+\d]/g, '')}" style="color:#2B7E8C;text-decoration:none;">${i.phone}</a></div>` : ''}
      </td>
      <td style="padding:12px 16px;border-bottom:1px solid #E2DDD5;vertical-align:top;">
