...
export const SYSTEM_GUIDES = {
  ...
  'mountain-living': {
    title: 'Mountain Living: A Front Range Home Guide',
    metaDescription:
      'Owning a home in the Colorado foothills around Evergreen means wells, septic, wood heat, snow load, and wildfire. What an inspector checks in mountain homes and what living up here takes. Inspectrum Inspections.',
    eyebrow: 'Local Living',
    heroTitle: 'Mountain Living',
    heroLead:
    ...
    imageKeywords: 'colorado,mountain,cabin',
    imageAlt: 'A mountain home in the Colorado foothills',
    proType: 'a qualified local specialist',
    sections: [
      {
        id: 'scope',
        name: 'What we check',
        heading: 'What we check in mountain homes',
        intro: 'Foothills homes have systems you won’t find in the city. Here’s where we focus — though wells, septic, and chimneys each have dedicated specialist inspections too.',
        items: [
          { h: 'Well & water systems', b: 'Many mountain homes are on a private well. We note the visible well equipment, pressure tank, and any treatment — water-quality and flow testing is a separate specialist service.' },
          { h: 'Septic systems', b: 'Where present, we note visible components and conditions; a dedicated septic inspection (and pump) is its own service.' },
          { h: 'Wood stoves & fireplaces', b: 'We check solid-fuel appliances, hearth clearances, and visible flue and chimney condition.' },
          { h: 'Roof & snow load', b: 'Steep pitches, snow-shedding patterns, and the extra wear heavy snow puts on roofs, gutters, and decks.' },
          { h: 'Heating & fuel', b: 'Many areas have no natural gas — we note propane tanks and lines and how the home stays warm.' },
          { h: 'Wildfire exposure', b: 'Defensible space, ignition-resistant materials, and the ember-vulnerable spots around the home.' },
        ],
      },
      {
        id: 'issues',
        ...
        heading: 'Common problems we find',
        items: [
          { h: 'Undocumented well/septic', b: 'Systems with no recent service records or unclear maintenance history.' },
          { h: 'Wood stove clearances', b: 'Solid-fuel appliances without proper clearances or with a flue overdue for inspection.' },
          { h: 'Access & driveways', b: 'Steep grades, drainage washouts, and driveways that are tough to keep open in winter.' },
          { h: 'Thin defensible space', b: 'Vegetation and debris too close to the home for wildfire safety.' },
          { h: 'Snow & ice damage', b: 'Ice dams, strained gutters, and heavy snow load on decks and porch roofs.' },
          { h: 'Power resilience', b: 'Outages are common up here, yet many homes have no backup heat or generator — a real concern with a well pump.' },
        ],
      },
      {
        id: 'maintain',
        name: 'Living up here',
        heading: 'What living up here takes',
        items: [
          { h: 'Tend the well & test water', b: 'Service the well and test the water periodically, and keep the records — they matter at resale.' },
          { h: 'Stay on the septic schedule', b: 'Pump and inspect the septic on schedule (often every few years, depending on use).' },
          { h: 'Sweep the chimney', b: 'Have wood stoves and chimneys swept and inspected before each heating season.' },
          { h: 'Keep defensible space', b: 'Clear the first 5 feet of flammables and thin vegetation from 5–30 feet, year-round.' },
          { h: 'Plan for snow', b: 'Rake roof edges, keep vents and exhausts clear, and stay ahead of the driveway.' },
          { h: 'Prepare for outages', b: 'Backup heat, stored water, and a generator are worth it — especially if your water depends on an electric pump.' },
          { h: 'Test for radon', b: 'Colorado’s mountain geology tends to run high — retest every couple of years.' },
        ],
      },
    ],
    related: [
      { label: 'Seasonal Maintenance Guide', href: '/guides/home-maintenance' },
      { label: 'Outdoor Safety & Yard', href: '/guides/outdoor-safety' },
      { label: 'Radon Testing', href: '/services/radon' },
    ],
  },
}
 ...
 */
const lf = (kw) => `https://loremflickr.com/600/400/${encodeURIComponent(kw)}`

export const CONTENT_PAGES = [
  { href: '/guides/home-maintenance', eyebrow: 'Seasonal', title: 'Home Maintenance, Season by Season', blurb: 'A spring-through-winter checklist tuned for Front Range homes.', image: '/guides/fall-guide-maintenance.png' },
  ...GUIDE_SLUGS.map((slug) => ({
    href: `/guides/${slug}`,
    eyebrow: SYSTEM_GUIDES[slug].eyebrow,
    title: SYSTEM_GUIDES[slug].heroTitle,
    blurb: SYSTEM_GUIDES[slug].heroLead,
    image: lf(SYSTEM_GUIDES[slug].imageKeywords),
  })),
  { href: '/services/full-inspection', eyebrow: 'Service', title: 'Full Home Inspection', blurb: 'A thorough, plain-English inspection of the whole home.', image: lf('house,home') },
  { href: '/services/radon', eyebrow: 'Service', title: 'Radon Testing', blurb: 'A 48-hour continuous radon test with same-day results.', image: lf('basement,home') },
  { href: '/services/mold', eyebrow: 'Service', title: 'Mold Assessment', blurb: 'Identify moisture and mold concerns before they spread.', image: lf('mold,wall') },
]
