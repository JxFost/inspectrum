...
function buildContactMethods(phone, email, address) {
  return [
    {
...
export default function ContactClient({ officePhone = '(303) 697-0990', officeEmail = 'office@evergreeninspections.com', officeAddress = 'Evergreen, CO 80439' }) {
  const CONTACT_METHODS = buildContactMethods(officePhone, officeEmail, officeAddress)
