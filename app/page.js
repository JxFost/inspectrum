...
const PROCESS_STEPS = [
  ...
  { num: '03', title: 'Walk Through & Report', body: 'You join us at the end so you can see every concern with your own eyes — and on paper. Get your report that day.' },
]

const HIGHLIGHT_STEP = {
  num: '04',
